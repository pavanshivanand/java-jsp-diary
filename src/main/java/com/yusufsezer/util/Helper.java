...
public class Helper {
    ...
    public static String DB_SOURCE = "jdbc:mysql://jsp-diary-server.mysql.database.azure.com:3306/jspDiary?useSSL=false&serverTimezone=UTC&user=root&password=&charset=UTF-8";
